...
Existe además, una interfaz web ya implementada conocida PhpLDAPAdmin \footnote{ poner referencia}
...
pertenece, etc. \todo[inline]{buscar si esto no pertenece a PosixGroup}

...
trabajadores y estudiantes \todo[inline]{ ... para presentarlas a través de una misma interfaz}. Desde su creación se han implementado, sobre este \todo[inline]{Sobre dicha interfáz}, varios 
...
intranet. Parte de este trabajo lo continua haciendo hasta hoy \todo[inline]{Todos los servicios implementados sobre directorio funcionan hasta hoy ... dios mediante.}. Otros servicios permiten
...
cargo que ocupa o departamento en que trabaja, en el caso de los trabajadores.\todo[inline]{y si quieres poner otro mas, recuerda el que decide el tamaño del buzón.}
...
que representa una fuente de información de todo el personal de la Universidad de La Habana. \todo[inline]{Es en verdad una gran ventaja, en realidad permite tener informacion centralizada, mas accesible, facilmente modificable ... pero se generan otros problemas, no se puede decir a la ligera que centralizar sea una gran ventaja.}
Además es un elemento necesario para garantizar el control apropiado del uso de dichas 
facilidades. \todo[inline]{Mas bien las facilidades surgieron como medio para poder atender los servicios centralizados. Tienen que entender que la centralizacion fue una politica de la universidad atendiendo al interes de tener mas control sobre a quien se le asignaban los servicions en las areas.}
...
esparcida en varios servidores\todo[inline]{Yo diria que lo otro es la información de los trabajadores de la UH, la cual se maneja por los departamentos de RH de cada una de las unidades presupuestadas de la UH}. De hecho, existe una base de datos 'Assets' por cada unidad
...
hacen necesarias en este momento. \todo[inline]{Que actualizaciones? Assets es un software para administracion de RH, que otras funcionalidades quieren implementar sobre esta db?} 
...
momento una instancia de usuario ha sido modificada. \todo[inline]{Es verdad, pero nuevamente, esta idea no parte del uso del sistema original sino de adaptarlo a nuestras condiciones especificas. Bien las secretarias de RH podrian decir que la información de un trabajador se actualizó en un sistema aparte a Assets luego de haber introducido el cambio en Assets }

Entre los datos más relevantes, almacenados en este sistema \todo[inline]{Valdria aclarar que el sistema es directorio}, se encuentra aquellos que 
...
hace, la cantidad de cuota de internet consumida, etc \todo[inline]{Esta parte no la almacena directorio, la almacena el nodo en otra base de datos aparte} . La otra parte, estando esta última 
más asociada a los trabajadores y externos, contiene información más personal. Entre la 
misma sobresalen \todo[inline]{Esto si se considera informacion parte de directorio} : 
...
pretende brindar una posible solución \todo[inline]{creo que una posible solución califica como la implementación de la solución: yo lo describiria como una propuesta de solución para el problema, asi  como su implementación.} , así como su implementación. Los problemas son 
...
de su mantenimiento \todo[inline]{Yo no diria que no tiene a nadie; directorio tiene personal de mantenimiento que no puede responder a las necesidades debido a la perdida del historial de cambios de su código.} . La principal causa de esta desatención, es que los desarrolladores 
...
diseño de las bases de datos \todo[inline]{Que base de datos??? Digan simplemente se han agregado nuevos campos de informacion al sistema. A modo de recordatorio, directorio tiene como db's: todo lo que hay en los Assets, todo lo que hay en SIGENU a través de sus webservices y la informacion de externos en una db myssql de directorio.} que representan las fuentes de información del sistema. 
...
del mismo. \todo[inline]{Esta oración esta correcta??? ... a consecuencia de la rigidez del mismo que .... se acaba la idea} 
...
refleja sobre todo en el espacio ocupado por la información en disco. \todo[inline]{Pulan un poco las oraciones arriba, no estan del todo coherentes.}
...
en el amplio campo de la ciencia de la computación \todo[inline]{Creo que deberiamos re-escrbir la primera parte de toda esta sección} . Teniendo esto en cuenta, es que se 

\begin{introduction}
    ...
    sociedad donde la automatización de los procesos ya no solo industriales, tambien cotidianos, \todo[inline]{Aqui separa oraciones como: . Esta automatizacion, mejora considerablemente ...}
    mejora considerablemente la calidez\todo[inline]{Creo que quisiste decir calidad.}, rapidez y robustez de los mismos, y donde el surgimiento 
    ...
    de diferentes tipos de información relacionada con el \todo[inline] {No pongas el departamento, pon los departamentos. Cada unidad presupuestada tiene un departamento de RH diferente.} departamento de Recursos Humanos, careciendo 
    ...
    de Ciencia y Tecnología Aplicada (InSTEC) \todo[inline]{Si quieres puedes mencionar tambien a IFAL, JBN y la DOM}. La gran mayoría de estos servicios requiere que el la 

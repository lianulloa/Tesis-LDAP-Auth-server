...
api.add_resource(resources.SecurityQuestions, '/recuperar-contraseña/<string:user_id>')
api.add_resource(resources.ChangePassword, '/cambiar-contraseña/<string:user_id>')
